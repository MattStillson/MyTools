...
Emitted after each incoming chunk of data that has been parsed. Can be used to roll your own progress bbb.
...
* [multipart-parser](http://github.com/aaaBarWidget/multipart-parser): a C++ parser based on formidable
